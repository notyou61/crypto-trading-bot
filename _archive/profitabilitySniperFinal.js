...
dotenv.config(); // ✅ Load .env BEFORE anything uses process.env
//
console.log("HOT_WALLET_PRIVATE_KEY =", process.env.HOT_WALLET_PRIVATE_KEY);

import fs from 'fs';
import { Keypair, PublicKey } from '@solana/web3.js';
import bs58 from 'bs58'; // Optional, keep for other parts of your script if needed
...
const recentTokens = await fetchRecentMints(50);

// ✅ Now it's safe to parse HOT_WALLET_PRIVATE_KEY
...
try {
  keypair = Keypair.fromSecretKey(bs58.decode(process.env.HOT_WALLET_PRIVATE_KEY));
